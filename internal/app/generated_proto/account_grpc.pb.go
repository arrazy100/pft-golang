...
const (
	AccountService_CreateAccount_FullMethodName = "/pft.AccountService/CreateAccount"
	AccountService_ListAccounts_FullMethodName  = "/pft.AccountService/ListAccounts"
	AccountService_GetAccount_FullMethodName    = "/pft.AccountService/GetAccount"
	AccountService_EditAccount_FullMethodName   = "/pft.AccountService/EditAccount"
	AccountService_DeleteAccount_FullMethodName = "/pft.AccountService/DeleteAccount"
)
...
type AccountServiceClient interface {
	...
	EditAccount(ctx context.Context, in *Account, opts ...grpc.CallOption) (*Account, error)
...
func (c *accountServiceClient) EditAccount(ctx context.Context, in *Account, opts ...grpc.CallOption) (*Account, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Account)
...
type AccountServiceServer interface {
	...
	EditAccount(context.Context, *Account) (*Account, error)
...
func (UnimplementedAccountServiceServer) EditAccount(context.Context, *Account) (*Account, error) {
...
func _AccountService_EditAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).EditAccount(ctx, req.(*Account))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pft.AccountService",
	...
	Metadata: "internal/app/proto/account.proto",
}
